...
public class ArticleMenuAdapter extends BaseAdapter {

    private LayoutInflater layoutinflater;
    private List<ArticleModel> listStorage;
    private Context context;

    public ArticleMenuAdapter(Context context, List<ArticleModel> customizedListView) {
